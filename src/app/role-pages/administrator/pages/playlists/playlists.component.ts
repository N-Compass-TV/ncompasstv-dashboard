...
export class PlaylistsComponent implements OnInit, OnDestroy {
    ...
    constructor(private _auth: AuthService, private _playlist: PlaylistService, private _date: DatePipe, private _dialog: MatDialog, private _titlecase: TitleCasePipe) {}
        ...
        return data.map((p) => {
            return new UI_TABLE_PLAYLIST(
                ...
                { value: count++, link: null, editable: false, hidden: false },
                {
                    ...
                    link: p.isMigrated ? `/administrator/playlists/v2/${p.playlistId}` : `/administrator/playlists/${p.playlistId}`,
                    editable: false,
                    hidden: false,
                    new_tab_link: true,
                },
