...
@NgModule({
    declarations: [AdvertisersComponent, DashboardComponent, HostsComponent, LicensesComponent, ScreensComponent, UsersComponent, SubDealerLayoutComponent, PlaylistsComponent],
    imports: [
        CommonModule,
        GlobalModule,
