            ...
            .subscribe(
                (response: { list: any[] }) => {
                    ...
                    advertiser_report.map((report) => {
                        ...
                        this.advertiser_report_chart.chart_data.push(report.total), this.advertiser_report_chart.chart_label.push(this._date.transform(month[0], 'MMM'));
                    });
            ...
            .subscribe(
                (response: { list: any[] }) => {
                    ...
                    host_report.map((report: { total: any; month: any }) => {
                        const month = report.month.split(' ');
                        this.host_report_chart.chart_data.push(report.total), this.host_report_chart.chart_label.push(this._date.transform(month[0], 'MMM'));
                    });
            ...
            .subscribe(
                (response) => {
                    ...
                    license_report.map((i) => {
                        ...
                        this.license_report_chart.chart_data.push(i.total), this.license_report_chart.chart_label.push(this._date.transform(month[0], 'MMM'));
                    });
