            ...
            .subscribe(
                (data: any) => {
                    ...
                    if (this.licenses_count) {
                        ...
                        this.temp_label_this_week.push(this.licenses_count.unassigned_value_label + ': ' + this.licenses_count.this_week_unassigned_value);
                        ...
                        this.temp_label_last_week.push(this.licenses_count.unassigned_value_label + ': ' + this.licenses_count.last_week_unassigned_value);
