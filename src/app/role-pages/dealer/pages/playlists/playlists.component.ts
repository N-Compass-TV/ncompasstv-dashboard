...
export class PlaylistsComponent implements OnInit, OnDestroy {
    ...
    constructor(private _auth: AuthService, private _date: DatePipe, private _dialog: MatDialog, private _playlist: PlaylistService, private _title: TitleCasePipe) {}
    ...
    playlist_mapToUI(data: API_PLAYLIST[]): UI_DEALER_PLAYLIST[] {
        ...
        return data.map((playlist) => {
            ...
            return new UI_DEALER_PLAYLIST(
                ...
                { value: playlist.name, data_label: 'playlist_name', is_migrated: playlist.isMigrated, link: playlistUrl, editable: false, hidden: false, new_tab_link: true },
