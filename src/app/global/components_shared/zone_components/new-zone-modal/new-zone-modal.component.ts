...
export class NewZoneModalComponent implements OnInit {
    ...
    zoneData(): API_ZONE {
        return new API_ZONE(this.f.zone_name.value, this.f.zone_x.value, this.f.zone_y.value, this.f.zone_height.value, this.f.zone_width.value, this.f.zone_background.value, 0);
    }
}
