...
export class BannerComponent implements OnInit, OnDestroy {
    ...
    @Input() page = '';
    @Input() page_data: { dealer: API_DEALER; user: API_USER_DATA } | { host: API_HOST; dealer: API_DEALER; createdBy: any } | { advertiser: API_ADVERTISER; dealer: API_DEALER } =
        null;
    ...
    onClickModify(): void {
        ...
        let data: { dealer: API_DEALER; user: API_USER_DATA } | { host: API_HOST; dealer: API_DEALER; createdBy: any } | { advertiser: API_ADVERTISER; dealer: API_DEALER };
    ...
    onCreateScreen(dealerId: string, hostId: string) {
        ...
        const url = this._router.serializeUrl(this._router.createUrlTree([`/${role}/screens/create-screen/`], { queryParams: { dealer_id: dealerId, host_id: hostId } }));
        window.open(url, '_blank');
    }
    ...
    private setLicenseStats(): void {
        ...
        const { total_ads_label, total_menu_label, total_closed_label, total_ads, total_menu, total_closed, unassigned_value, unassigned_value_label } = this.host_license_count;
    ...
    private setUserTypeData(): void {
        let tags: TAG[];
        let status: string;
        let data: { dealer: API_DEALER; user: API_USER_DATA } | { host: API_HOST; dealer: API_DEALER } | { advertiser: API_ADVERTISER; dealer: API_DEALER };
