...
export class InstallationsTabComponent implements OnInit {
    ...
    getLicensesInstallationStatistics() {
        ...
        if (this.selected_dealer || (this.start_date && this.end_date)) {
            this._license.get_licenses_installation_statistics_detailed(this.selected_dealer, this.start_date, this.end_date).subscribe((data) => {
                if (!data.message) {
                    this.generate = true;
    ...
    getGraphPoints(e) {
        ...
        this._license.get_licenses_installation_statistics_detailed('', this.temp_start_date, this.temp_end_date).subscribe((data) => {
            if (data.licenses) {
