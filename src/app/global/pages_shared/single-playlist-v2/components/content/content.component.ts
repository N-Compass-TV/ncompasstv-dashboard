...
export class ContentComponent implements OnInit, OnDestroy {
    ...
    private prepareThumbnails() {
        ...
        /** webm assets  */
        if (this.content.fileType === 'webm') this.content.thumbnail = `${this.content.url}${this.content.fileName.substring(0, this.content.fileName.lastIndexOf('.') + 1)}jpg`;
    ...
    private subscribeToContentHover() {
        this._helper.onHoverContent.pipe(takeUntil(this._unsubscribe)).subscribe((response) => {
            ...
            result = this.isParentFrequency ? this.content.playlistContentId === playlistContentId : this.content.parentId === playlistContentId;
