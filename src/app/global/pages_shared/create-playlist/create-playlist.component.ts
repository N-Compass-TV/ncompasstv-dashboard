...
import { API_CONTENT, API_CREATE_PLAYLIST, API_CREATE_PLAYLIST_CONTENT, API_DEALER, UI_CONTENT, UI_PLAYLIST_CONTENT, UI_ROLE_DEFINITION } from 'src/app/global/models';
...
export class CreatePlaylistComponent implements OnInit {
    ...
    createPlaylist() {
        ...
        this.playlist = new API_CREATE_PLAYLIST(this.f.dealer.value, this.f.playlistName.value, 'unset', this.f.playlistDescription.value, this.playlist_assets);
    ...
    getAllContents() {
        ...
        this._content.get_contents_temp(this.current_page, this.media_key, this.sort_key, this.dealerid, this.search_data, this.floating_content).subscribe((data) => {
