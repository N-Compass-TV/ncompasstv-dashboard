...
import { API_CONTENT, UI_TABLE_ADVERTISERS_CONTENT, UI_ROLE_DEFINITION_TEXT, API_ADVERTISER, API_DEALER, UI_ACTIVITY_LOGS, API_USER_DATA } from 'src/app/global/models';
    ...
    private mapContentsToTableUI(contents: API_CONTENT[]): UI_TABLE_ADVERTISERS_CONTENT[] {
        ...
        return contents.map((content) => {
            return {
                ...
                type: {
                    value: content.fileType == 'jpeg' || content.fileType == 'jfif' || content.fileType == 'jpg' || content.fileType == 'png' ? 'Image' : 'Video',
                    link: null,
                    editable: false,
                    hidden: false,
                },
