...
export class LicensesTabComponent implements OnInit, OnDestroy, AfterViewInit {
    ...
    onPushUpdate(): void {
        this.openWarningModal('warning', 'Push Updates', 'Are you sure you want to push updates?', 'Click OK to push updates for this license', 'update');
    }

    onScreenshotHost(): void {
        this.openWarningModal('warning', 'Screenshot Host', "Screenshot all this host's licenses, Requires a reload after a minute or two.", 'Click OK to continue', 'screenshot');
    }

    onRebootPlayer(): void {
        this.openWarningModal('warning', 'Reboot Player (Software)', 'Are you sure you want to reboot player?', 'Click OK to reboot software', 'reboot_player');
    }
