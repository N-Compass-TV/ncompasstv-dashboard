...
export class EditFillerGroupComponent implements OnInit {
    ...
    onSubmit() {
        ...
        this._filler
            ...
            .pipe(takeUntil(this._unsubscribe))
            .subscribe((data: any) => this.openConfirmationModal('success', 'Filler Group Updated!', 'Hurray! You successfully modified a Filler Group', true));
    }
        ...
        return {
            ...
            onUploadDone: (response) => {
                ...
                this._filler
                    ...
                    .pipe(takeUntil(this._unsubscribe))
                    .subscribe(() => this.openConfirmationModal('success', 'Filler Group Cover Photo Updated!', 'Hurray! You successfully updated Filler Group Cover Photo'));
            },
        };
    }
