...
export class FillersComponent implements OnInit {
    ...
    setFilters(event) {
        ...
        if (this.current_tab == 0) this.getAllFillers(this.current_filter.page, this.current_filter.keyword, this.current_filter.sort_col, this.current_filter.sort_ord);
        else if (this.current_tab == 1)
            if (this.is_dealer) {
                this.getFillersOtherRole(this.current_role, this.current_filter.page, this.current_filter.keyword, this.current_filter.sort_col, this.current_filter.sort_ord);
            } else if (this.is_dealer_admin) this.getAllFillers(this.current_filter.page, this.current_filter.keyword, this.current_filter.sort_col, this.current_filter.sort_ord);
            else {
                this.getDealerAdminsDealerFillers(this.current_filter.page, this.current_filter.keyword, this.current_filter.sort_col, this.current_filter.sort_ord, 'dealeradmin');
            }
        else {
            if (this.is_dealer_admin) {
                this.getDealerAdminsDealerFillers(this.current_filter.page, this.current_filter.keyword, this.current_filter.sort_col, this.current_filter.sort_ord, 'dealer');
            } else if (this.is_dealer) {
                this.getDealerAdminsDealerFillers(this.current_filter.page, this.current_filter.keyword, this.current_filter.sort_col, this.current_filter.sort_ord, 'dealeradmin');
            } else {
                this.getDealerFillersAdminView(this.current_filter.page, this.current_filter.keyword, this.current_filter.sort_col, this.current_filter.sort_ord);
            }
        }
    }
